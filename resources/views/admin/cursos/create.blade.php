            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('ediciones.cursos.store' }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="nombre" class="block text-gray-700">Curso</label>
                            <textarea id="tinymce" name="nombre" id="nombre" class="w-full border-gray-300 rounded-md">
