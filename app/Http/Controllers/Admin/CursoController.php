...
class CursoController extends Controller
{
    ...
    public function index(Edicion $edicion)
    {
        ...
        return view('admin.cursos.index', compact('cursos', 'edicion'));
    }
    ...
    public function edit(Curso $curso)
    {
        ...
        return view('admin.ediciones.edit', compact('curso', 'edicion'));
    }
    ...
    public function update(Request $request, Curso $curso)
    {
        ...
        return redirect()->route('ediciones.cursos.store', ['edicion' => $edicion])->with('success', 'Curso actualizado correctamente.');
    }
    ...
    public function destroy(Curso $curso)
    {
        ...
        return redirect()->route('ediciones.cursos.store', ['edicion' => $edicion])->with('success', 'Curso eliminado correctamente.');
    }
}
